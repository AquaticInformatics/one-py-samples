...
colIdsUsingReportId =client.Report.GetColumnsIdsByReportId(nameId[0])
colIdsUsingName = client.Report.GetColumnsIdsByReportName(nameId[1], plantId)
colIdsForWholePlant =client.Report.GetReportColumnsIdsByPlant(plantId)
